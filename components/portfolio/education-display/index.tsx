...
const EducationComponent = (props: EducationComponentProps) => {
  ...
  return (
    <Card style={style.card} headStyle={style.header} title={<HeaderCardComponent title={school} description={classroom} src={image} />}>
      <Row justify="start">
        <Descriptions style={style.description} size="small">
          <Descriptions.Item style={style.descriptionItem} labelStyle={style.descriptionLabel} label="Nível">
          ...
          <Descriptions.Item style={style.descriptionItem} labelStyle={style.descriptionLabel} label="Período">
