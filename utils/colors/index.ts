...
export default {
  ...
  gray: ['#fafafa', '#f5f5f5', '#f0f0f0', '#d9d9d9', '#bfbfbf', '#8c8c8c', '#595959', '#434343', '#262626', '#1f1f1f', '#141414'],
  white: '#ffffff',
  black: '#000000',
};
...
export const isThemeColor = (color: string) => colorList.includes(color as ThemeColor);
